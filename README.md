...
- **[通用写法指南](guides/)** — 简历格式、ATS 优化、工作经历写法等基础问题
  ...
  - [简历要写几页？什么情况下可以超过一页](guides/one-page-resume.md)
...
- **[面试技巧](interview/)** — 自我介绍、谈薪、高频问题应答
  ...
  - [面试自我介绍怎么说：90 秒完整模板](interview/self-introduction.md)
...
| 问题 | 去哪找 |
|------|--------|
| 简历格式怎么选？ | [guides/resume-format.md](guides/resume-format.md) |
| 如何通过 ATS 筛选？ | [guides/ats-keywords.md](guides/ats-keywords.md) |
